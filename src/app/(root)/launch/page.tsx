...
export default function LaunchPage() {
    ...
    return (
        <div className="flex flex-col items-center space-y-16">
            <h1 className="text-4xl font-bold font-mono uppercase tracking-wider text-foreground/80">Launch Your Coin</h1>
                                ...
                                <div className="space-y-6">
                                    ...
                                    {user && !tokenData.hideIdentity && (
                                        <div className="pt-4 border-t">
                                            <p className="text-xs font-mono text-muted-foreground mb-3 uppercase">CREATOR::IDENTITY</p>
                                            <a
                                            ...
                                            >
                                                <div className="relative">
                                                    ...
                                                    <TwitterUserAvatar user={user} className="relative h-10 w-10 rounded-full border-2" />
                                                </div>
                                                <div>
