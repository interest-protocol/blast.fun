...
const CreateTokenForm: FC<CreateTokenFormProps> = ({ onFormChange }) => {
    ...
    return (
        <div
            className="w-full p-4 rounded-xl border-2 bg-background/50 backdrop-blur-sm shadow-2xl"
            onPaste={handlePaste}
        >
            <Form {...form}>
                <form className="space-y-6">
                        ...
                        render={({ field }) => (
                            <FormItem className="rounded-lg border-2 border-dashed p-4 bg-background/50">
                                <div className="space-y-3">
                                    ...
                                    <FormDescription className="font-mono text-xs uppercase text-muted-foreground">
                                        The burn/sell tax is progressive: it
                                        starts at 0% and increases up to the max
                                        % chosen by the creator, depending on
                                        how close the pool is to full bonding.
                                    </FormDescription>
                                    <FormMessage className="font-mono text-xs" />
                                </div>
                            </FormItem>
                    ...
                    <Collapsible
                        open={showProtectionSettings && sniperProtection}
                        onOpenChange={setShowProtectionSettings}
                    >
