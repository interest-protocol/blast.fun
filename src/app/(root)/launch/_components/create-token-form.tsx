...
const tokenSchema = z.object({
	...
	symbol: z.string().min(2, "Minimum 2 characters").max(10, "Maximum 10 characters").regex(/^[a-zA-Z][\x21-\x7E]*$/),
				...
				<Form {...form}>
					<form className="space-y-8">
						<div className="flex gap-6">
							...
							<div className="flex-1 space-y-4">
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											<FormLabel className="font-mono text-xs uppercase tracking-wider text-foreground/60">TOKEN::NAME</FormLabel>
											<FormControl>
												<Input
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											<FormLabel className="font-mono text-xs uppercase tracking-wider text-foreground/60">TOKEN::SYMBOL</FormLabel>
											<FormControl>
												<Input
													placeholder="[TICKER]"
													className="font-mono focus:border-primary/50"
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									<FormLabel className="font-mono text-xs uppercase tracking-wider text-foreground/60">PROJECT::DESCRIPTION</FormLabel>
									<FormControl>
										<Textarea
						...
						<div className="space-y-4">
							...
							<div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											<FormLabel className="font-mono text-xs uppercase tracking-wider text-foreground/60">WEB</FormLabel>
											<FormControl>
												<Input
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											<FormLabel className="font-mono text-xs uppercase tracking-wider text-foreground/60">TELEGRAM</FormLabel>
											<FormControl>
												<Input
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											<FormLabel className="font-mono text-xs uppercase tracking-wider text-foreground/60">X</FormLabel>
											<FormControl>
												<Input
