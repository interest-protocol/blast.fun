...
import { TokenPageWrapper } from "@/views/token/coin-type/_components/token-page-wrapper";
...
function normalizeToken(t: Token | null): Token | null {
    ...
    return {
        ...
        pool: t.pool
            ...
            : undefined,
        createdAt:
            typeof t.createdAt === "number" && !Number.isNaN(t.createdAt)
                ? t.createdAt
                : Date.now(),
        ...
        return (
            <div className="container mx-auto px-4 py-8">
                <div className="text-center">
                    <h1 className="font-mono font-semibold text-muted-foreground text-xl uppercase">
                        TOKEN_NOT_FOUND
                    </h1>
