		...
		<div className="w-full border-border border-b">
				...
				<div className="flex items-center gap-3">
					...
					<div className="min-w-0 flex-1">
						<div className="mb-1 flex items-center gap-2">
							<h3 className="truncate font-bold font-mono text-foreground/90 text-sm uppercase tracking-wider">
						...
						<div className="flex items-center gap-2">
							...
							<RelativeAge
								...
								className="font-medium text-muted-foreground/60 text-xs uppercase tracking-wide"
							/>
							<span className="text-muted-foreground/40">·</span>
							<span className="text-muted-foreground/60 text-xs uppercase tracking-wide">by</span>
							<CreatorDisplay
			...
			<div className="flex items-center justify-between">
				...
				<div className="flex w-full flex-col items-center justify-center border-border border-r py-2">
					...
					<p className="text-xs text-yellow-500">${formatNumberWithSuffix(marketData?.marketCap || 0)}</p>
				</div>
				<div className="flex w-full flex-col items-center justify-center py-2">
					<p className="text-[10px] text-muted-foreground">24h Vol</p>
					<p className="text-purple-500 text-xs">${formatNumberWithSuffix(marketData?.volume24h || 0)}</p>
				</div>
			</div>
		</div>
	)
