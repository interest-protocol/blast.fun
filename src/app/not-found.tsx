...
export default function NotFound() {
	return (
		<div className="mx-auto flex h-screen flex-col items-center justify-center space-y-8 p-6">
			<div className="flex flex-col items-center">
				<h1 className="font-bold text-4xl tracking-tighter sm:text-5xl md:text-6xl">404</h1>
