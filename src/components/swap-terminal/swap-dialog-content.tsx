...
export const SwapDialogContent: FC<SwapDialogContentProps> = ({
	...
	<DialogContent className="max-w-md p-0 gap-0">
		<DialogHeader className="px-3 pt-3 pb-2 border-b border-border/50">
			<DialogTitle className="font-mono text-sm uppercase tracking-wider">SWAP::TERMINAL</DialogTitle>
		</DialogHeader>
		<div className="p-3 space-y-3">
			...
			/>
			<SettingsBar slippage={slippage} onSettingsClick={onSettingsClick} />
			<SwapActionButton
				fromToken={fromToken}
				toToken={toToken}
