...
export const BlastTab: FC<BlastTabProps> = ({ searchQuery, onSelectToken, fromToken, toToken }) => {
	...
	const [expandedCategory, setExpandedCategory] = useState<TokenCategory | null>(DEFAULT_EXPANDED_CATEGORY);
