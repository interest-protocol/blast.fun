...
import { SUI_ICON_URL, WALLET_TOKENS_STALE_TIME, WALLET_TOKENS_REFETCH_INTERVAL } from "./swap-terminal.data";

const convertToTokenOption = (coin: WalletCoin): TokenOption => ({
	coinType: coin.coinType,
	symbol: coin.symbol,
	name: coin.name,
	iconUrl: normalizeStructTag(coin.coinType) === normalizeStructTag(SUI_TYPE_ARG) ? SUI_ICON_URL : coin.iconUrl,
