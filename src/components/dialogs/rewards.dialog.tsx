...
export function RewardsDialog({ open, onOpenChange }: RewardsDialogProps) {
	...
	const handleClaim = useCallback(
		...
		[mergeAndPrepareReceive, signAndExecuteTransaction, fetchWalletCoins]
	)
	...
	}, [walletCoins, mergeAndPrepareReceive, signAndExecuteTransaction, fetchWalletCoins])
	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="max-h-[80vh] max-w-4xl overflow-auto">
				<DialogHeader>
					<DialogTitle className="font-bold font-mono text-xl uppercase tracking-wider">
						Referral Rewards
					</DialogTitle>
				</DialogHeader>
					...
					<div className="overflow-hidden rounded-lg border border-border bg-card">
						{isLoading ? (
							<div className="flex flex-col items-center justify-center py-16">
								...
								<p className="mt-3 font-mono text-muted-foreground text-sm">Loading wallet rewards...</p>
							</div>
						) : walletCoins.length > 0 ? (
								...
								<table className="w-full">
									<thead>
										<tr className="border-border border-b bg-muted/50">
											<th className="p-4 text-left font-medium font-mono text-muted-foreground text-sm uppercase">
												Token
											</th>
											<th className="p-4 text-right font-medium font-mono text-muted-foreground text-sm uppercase">
												Balance
											</th>
											<th className="p-4 text-right font-medium font-mono text-muted-foreground text-sm uppercase">
												Value
											</th>
											<th className="p-4 text-center font-medium font-mono text-muted-foreground text-sm uppercase">
												Action
											</th>
										</tr>
									</thead>
							...
							<div className="flex flex-col items-center justify-center py-16">
								<p className="font-mono text-muted-foreground text-sm uppercase">No rewards available</p>
							</div>
						)}
					</div>
				</div>
