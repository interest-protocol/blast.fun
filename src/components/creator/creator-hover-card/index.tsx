...
const CreatorHoverCard: FC<CreatorHoverCardProps> = ({ twitterHandle, walletAddress, children, data }) => {
	...
	return (
		<HoverCard>
			...
			<HoverCardContent
				className="w-80 p-0 bg-background/50 backdrop-blur-sm
             border-2 border-border/40 shadow-2xl select-none"
				sideOffset={5}
			>
				<div className="p-4">
