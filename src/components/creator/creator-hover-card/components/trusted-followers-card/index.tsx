		...
		<Tooltip delayDuration={2000}>
			<TooltipTrigger asChild>
				<div className="relative group flex-1 cursor-help">
					...
					>
						<UserCheck className="h-4 w-4 mb-1" style={{ color: `rgba(${colorRgb}, 0.8)` }} />
						<p className="font-mono text-sm font-bold text-foreground/80 whitespace-nowrap">{count}</p>
						<p className="font-mono text-[10px] uppercase tracking-wider text-muted-foreground">TRUSTED</p>
					</div>
				</div>
			</TooltipTrigger>
