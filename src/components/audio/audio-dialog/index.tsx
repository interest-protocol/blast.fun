		...
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="sm:max-w-[400px] backdrop-blur-sm border-2 shadow-2xl">
				<DialogHeader className="pb-2 border-b">
					...
					<DialogDescription>Toggle miscellanous sounds for new tokens, and buying & selling.</DialogDescription>
				</DialogHeader>
				...
				<div className="space-y-2">
					...
					{!localEnabled && (
						<div className="text-center py-2">
							...
							<p className="font-mono text-xs uppercase text-muted-foreground">AUDIO::DISABLED</p>
						</div>
					)}
				</div>
			</DialogContent>
