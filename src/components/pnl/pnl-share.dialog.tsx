						...
						>
							...
							<div className="relative z-10 flex h-full w-full flex-col p-6">
								...
								<div className="flex items-center gap-3">
									...
									<div className="text-lg font-semibold text-white">{name || "Unknown"}</div>
								</div>
								...
								<div className="flex-1 flex flex-col justify-center">
									...
									>
										...
										>
											{isProfit ? "+" : "-"}
											{getCurrencySymbol()}
											{showInSui && suiPrice.price && suiPrice.price > 0
												? formatNumberWithSuffix(pnlAmount / suiPrice.price)
												: formatNumberWithSuffix(pnlAmount || 0)}
											{getCurrencySuffix()}
										</div>
									</div>
						...
						<div className="flex flex-col gap-3 w-[600px]">
								...
								>
									<div className="flex gap-2 items-center">
										{DEFAULT_BACKGROUNDS.map((bg, idx) => (
											...
											>
												<img src={bg} alt="" className="h-full w-full object-cover rounded-md" />
											</button>
										))}
							...
							<div className="flex justify-between items-center">
								<Button
									...
									size="sm"
									className="text-xs"
									disabled={suiPrice.isLoading || !suiPrice.price}
								>
