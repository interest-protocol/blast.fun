...
async function fetchNewlyCreatedCoins(filters?: TokenListSettings["filters"]): Promise<NoodlesCoinList[]> {
		...
		if (error) {
			return (
				<div className="p-8 text-center">
					...
					<p className="font-mono text-xs uppercase text-destructive">ERROR::LOADING::FEED</p>
				</div>
			);
		}
