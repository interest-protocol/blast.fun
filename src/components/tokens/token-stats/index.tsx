...
const TokenStats: FC<TokenStatsProps> = memo(function TokenStats({ marketCap, volume24h, holdersCount }) {
	return (
				...
				<Tooltip>
					<TooltipTrigger asChild>
						<div className="flex items-center gap-1">
							<span className="text-muted-foreground/60 uppercase tracking-wider text-[9px] sm:text-[10px]">
								MC
							</span>
