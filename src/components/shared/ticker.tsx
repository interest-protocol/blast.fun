            ...
            <div className="relative flex">
                <div className="flex animate-ticker whitespace-nowrap">
                    {[...displayItems, ...displayItems].map((item, index) => (
                        <span key={index} className="mx-8 font-mono text-sm uppercase tracking-wider text-foreground/80 flex items-center gap-2">
                            {item.iconUrl && (
                                <img
                                    src={item.iconUrl}
                                    alt="token"
                ...
                <div className="flex animate-ticker whitespace-nowrap" aria-hidden="true">
                    {[...displayItems, ...displayItems].map((item, index) => (
                        <span key={`duplicate-${index}`} className="mx-8 font-mono text-sm uppercase tracking-wider text-foreground/80 flex items-center gap-2">
