...
import { TickerItem } from "./trade-ticker.types"
                ...
                >
                    {[...trades, ...trades].map((trade, index) => (
                        <Link
                            ...
                            className="ticker-item inline-flex items-center gap-2 px-4 h-full
                             hover:bg-accent/30 transition-colors whitespace-nowrap"
                        >
