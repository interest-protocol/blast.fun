...
const ConnectWallet: FC<ConnectWalletProps> = ({
	...
	<div className={className}>
		<div className="flex flex-col items-center justify-center min-h-[60vh]">
			...
			{subtitle && <p className="font-mono text-xs uppercase text-muted-foreground/60 mt-2">{subtitle}</p>}

			<Button variant="outline" onClick={onConnect} className="font-mono uppercase tracking-wider mt-6">
				{buttonText}
			</Button>
		</div>
	</div>
