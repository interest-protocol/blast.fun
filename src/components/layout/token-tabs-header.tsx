			...
			>
				<div className="flex items-center gap-2 min-w-0 w-full justify-start">
					...
					<div className="flex flex-col items-start min-w-0 flex-1 gap-0.5">
						<span className="text-xs font-medium truncate w-full leading-tight text-left">{tab.symbol}</span>
...
export const TokenTabsHeader = memo(function TokenTabsHeader() {
	...
	return (
		<div className="border-b border-border">
			<div className={cn("flex items-center py-1.5 px-4 gap-2 ", !tabs.length && "justify-center")}>
				<SearchToken mode={tabs.length ? "tab" : "header"} />
