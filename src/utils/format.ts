...
export const formatNumberWithSuffix = (value: number | undefined, decimals?: number): string => {
	...
	const formatted =
		decimals !== undefined ? scaled.toFixed(decimals) : parseFloat(scaled.toFixed(decimalPlaces)).toString();
