 ...
 */
function getTimestampValue(token: SortableToken, field: "createdAt" | "lastTradeAt"): number {
	if (field === "createdAt") {
...
export function sortTokens(tokens: ReadonlyArray<NoodlesCoinList>, sortBy: TokenSortOption): ReadonlyArray<NoodlesCoinList> {
