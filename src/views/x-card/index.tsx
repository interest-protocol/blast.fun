...
const XCard = ({ params }: { params: Promise<{ id: string }> }) => {
                ...
                <div className="flex-1 flex items-center justify-center p-4">
                    <div className="text-center max-w-sm">
                        ...
                        <button
                            ...
                            className="mt-6 px-4 py-2 font-mono text-xs uppercase tracking-wider border border-foreground/20 
                            rounded hover:bg-foreground/10 transition-colors"
                        >
                            BROWSE::TOKENS
                        </button>
                    </div>
