        ...
        const calculateMaxBuyable = async () => {
            ...
            try {
                ...
                const totalSupplyInSmallestUnit =
                    TOTAL_POOL_SUPPLY * BigInt(10 ** decimals);
                const maxTokenAmount =
                    (totalSupplyInSmallestUnit *
                        BigInt(Math.floor(maxHoldingPercent * 100))) /
                    10000n;
    ...
    return (
        <div className="relative border-b border-border">
            ...
            <div className="p-3 space-y-3">
                    ...
                    !pool.pool?.migrated && (
                        <div className="flex items-center gap-2 p-3 rounded-lg border border-yellow-500/30 bg-yellow-500/5">
                            ...
                            <span className="text-xs text-yellow-500 font-medium">
                                This {tradeType} will reveal your X (Twitter)
                                username in trade history table.
                            </span>
                        </div>
                    )}
                ...
                {((tradeType !== "burn" &&
                    error &&
                    !error.includes("AUTHENTICATED WITH X")) ||
