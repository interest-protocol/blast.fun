...
const CreatorHeader: FC<CreatorHeaderProps> = ({
	...
	<div className="flex items-center justify-between mb-3">
		<div className="flex flex-col gap-0.5">
			<p className="font-mono font-medium text-[10px] uppercase tracking-wider text-muted-foreground">Created by</p>
			<div className="flex items-center gap-1.5">
				<span className="font-mono text-sm font-bold text-foreground">{displayName}</span>
				{showTwitterCreator && (
					<a
						href={
							creatorTwitterId
