...
import { MobileTab, MobileTokenViewProps } from "./mobile-token-view.types"
import { useMobileTabs } from "./mobile-token-view.data"

const MobileTokenView: FC<MobileTokenViewProps> = ({
    pool,
    referral,
    realtimePrice,
    realtimeMarketCap
...
export default MobileTokenView;