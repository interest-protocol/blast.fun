...
const CreatorRewardsTab: FC = () => {
	...
	const { rewards, isLoading, claimReward, claimAllRewards, transferPosition, isClaiming, isTransferring } =
		useCreatorRewards();
	...
	if (!isConnected) return <NotConnectedState onConnect={() => setIsConnectDialogOpen(true)} />;
