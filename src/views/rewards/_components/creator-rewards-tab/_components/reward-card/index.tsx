	...
	return (
		<Card className="p-4 flex flex-col items-center text-center hover:border-foreground/20 transition-colors">
			...
			<div className="flex-1 w-full">
				...
				<p className="text-xs text-muted-foreground font-mono mb-2">{reward.memeCoinSymbol || "---"}</p>
				...
				<div className="py-2 px-3 rounded-md bg-muted/50 border">
					...
					<div className="flex items-center justify-center gap-1.5">
						<span className="text-xl font-bold font-mono">{formatNumberWithSuffix(amount)}</span>
			...
			<div className="flex gap-2 w-full mt-3">
				...
				<Button size="sm" className="flex-1" disabled={isClaiming || amount === 0} onClick={onClaim}>
