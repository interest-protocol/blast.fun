...
const TransferPositionDialog: FC<TransferPositionDialogProps> = ({ open, onOpenChange, tokenSymbol, onConfirm }) => {
	const { recipientAddress, setRecipientAddress, isTransferring, error, setError, handleTransfer, handleClose } =
	...
	return (
		<Dialog open={open} onOpenChange={handleClose}>
			<DialogContent className="sm:max-w-md">
				...
				<DialogFooter>
					<Button variant="outline" onClick={handleClose} disabled={isTransferring} size="sm">
						Cancel
					</Button>

					<Button onClick={handleTransfer} disabled={isTransferring || !recipientAddress.trim()} size="sm">
						{isTransferring ? (
							<>
