	...
	if (!searched) {
		return (
			<div className="p-12 text-center">
				...
				<p className="font-mono text-sm uppercase text-muted-foreground">Enter a creator address to search</p>
			</div>
		);
	}
	...
	return (
		<div>
			<div className="p-4 border-b border-border/50">
				<p className="font-mono text-xs uppercase text-muted-foreground">Found {tokens.length} token(s)</p>
			</div>
