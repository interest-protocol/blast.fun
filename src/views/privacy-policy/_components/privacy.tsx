...
const Privacy: FC = () => (
	<>
		<PrivacySection title="1. Personal Data Controller">
			<p>
				“Personal Data” means information that can be associated with a specific person and can identify them. It
				excludes aggregated or anonymized data. For purposes of applicable law, <strong>GiveRep Labs</strong> acts as
				the Personal Data controller, meaning we determine the purposes and means of processing Personal Data.
			</p>
		</PrivacySection>
		...
		<PrivacySection title="2. Types of Personal Data Collected">
			...
			<p>
				We may also collect Personal Data from publicly available sources or third parties. Unless specified
				otherwise, requested Personal Data is mandatory to access the Services.
			</p>
		</PrivacySection>
		...
		<PrivacySection title="4. Cookies & Similar Technologies">
			<p>
				We use cookies and similar technologies (“Cookies”) to enable core functionality, improve performance, and
				analyze usage. Cookies may be:
			</p>
			...
			<p>
				You can control or delete Cookies via browser/device settings, but some features may not function properly if
				disabled.
			</p>
		</PrivacySection>
		...
		<PrivacySection title="5. Methods & Legal Basis of Processing">
			<p>
				We take appropriate security measures to prevent unauthorized access, disclosure, alteration, or destruction
				of Personal Data.
			</p>
		...
		<PrivacySection title="8. Retention of Personal Data">
			<p>
				We retain Personal Data as long as necessary for the purposes collected, including legal and regulatory
				compliance. Once no longer needed, data will be deleted or anonymized, except for data recorded on public
				blockchains, which cannot be altered.
			</p>
		</PrivacySection>
		...
		<PrivacySection title="9. Privacy Technology Practices">
			<ul className="list-disc pl-6 space-y-2">
				<li>
					<strong>Links to Third Parties:</strong> We are not responsible for the privacy practices of third-party
					websites or services linked to <strong>Blast</strong>.
				</li>
				<li>
					<strong>Data Security:</strong> We employ administrative, technical, and physical safeguards, but cannot
					guarantee absolute security.
				</li>
				<li>
					<strong>Blockchain Transactions:</strong> Transactions may be recorded on public blockchains, which are
					immutable and not controlled by <strong>GiveRep Labs</strong>.
				</li>
			</ul>
		</PrivacySection>
		...
		<PrivacySection title="11. Exercising Your Rights & Complaints">
			<p>
				To exercise rights or submit complaints, contact <strong>GiveRep Labs</strong> Support with sufficient
				identifying information and your request details. We will investigate and respond as required by law. You may
