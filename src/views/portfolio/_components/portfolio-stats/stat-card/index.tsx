		...
		<Card className={cn("p-3 md:p-6 border-2 bg-background/50 backdrop-blur-sm", className)}>
			<div className="flex flex-col md:flex-row md:items-start md:justify-between">
				<div className="space-y-1 md:space-y-2">
					...
					<p className={cn("font-mono text-base md:text-2xl font-bold", color)}>{value}</p>
					{description && <p className="font-mono text-xs md:text-sm text-muted-foreground/60">{description}</p>}
				</div>
