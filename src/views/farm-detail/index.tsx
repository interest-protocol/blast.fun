...
import FarmTerminal from "./_components/farm-terminal";
		...
		<div className="container max-w-7xl mx-auto px-3 md:px-4 py-4 md:py-8">
			<div className="space-y-4 md:space-y-6">
				<div className="flex items-center justify-between gap-4">
					<Button variant="ghost" size="sm" onClick={() => router.push("/farms")} className="font-mono">
					...
					{isConnected && farmAccounts.length > 0 && (
						...
						>
							<SelectTrigger
								className="w-auto min-w-[220px] font-mono"
								aria-label="Conta da farm para depósito, stake e withdraw"
							>
