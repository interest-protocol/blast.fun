...
const FarmRow: FC<FarmRowProps> = ({ farm, account }) => {
	...
	const { tvlAmount, tvlUsd, stakedAmount, stakedUsd } = useFarmValues(farm, staked, stakeTokenPrice);
	...
	return (
		...
		>
			<div className="flex items-center justify-between p-3 md:p-4">
				<TokenInfo iconUrl={metadata?.iconUrl || ""} tokenName={tokenName} tokenSymbol={tokenSymbol} />

				<div className="flex items-center gap-3 md:gap-8">
					<FarmApr apr={apr} isLoading={isAprLoading} />
					<FarmTvl
						tvlUsd={tvlUsd}
						tvlAmount={tvlAmount}
